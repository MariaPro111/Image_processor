...
Используется 24-битный BMP без сжатия и без таблицы цветов. Тип используемого `DIB header` - `BITMAPINFOHEADER`.
...
В формулах далее считается, что каждая компонента цвета
...
Самостоятельно придуманный фильтр.